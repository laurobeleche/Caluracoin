...
const string strMessageMagic = "CaluraCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
            ...
            if(nBestHeight == 0)
            {
            nSubsidy = 2500000 * COIN; //premine for pre-sale, bounty, airdrop, exchange listing and others
			}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CaluraCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nNonce   = !fTestNet ? 870327 : 870327 ;
        ...
        assert(block.hashMerkleRoot == uint256("0xcdf6d248bf20a3764225e74d5039a8f3169104540ed6fc466ea8fc64b016cbf6"));
...
unsigned char pchMessageStart[4] = { 0x71, 0xae, 0x76, 0x64 };
